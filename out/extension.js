...
function getStyleName(documentText) {
    let counter = 1;
        ...
        if (editor) {
            ...
            editor
                ...
                if (!editor.document
                    ...
                    editBuilder.insert(startOfFirstLine, 'import { StyleSheet } from "react-native";\n');
                }
            })
                .then(() => {
            ...
            vscode.window.showInformationMessage("Inline style successfully converted to StyleSheet!");
        }
        else {
            vscode.window.showErrorMessage("Please select an inline style to convert.");
        }
    });
